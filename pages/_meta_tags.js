...
const MetaTags = ({ metatags }) => {
	return (
		<Head>
			...
			{metatags?.og_site_name && <meta property='og:site_name' content={SITE_DATA.NAME} />} {/** SET DEFAULT */}
			{metatags?.og_url && <meta property='og:url' content={metatags.og_url} />}
			{metatags?.og_image && <meta property='og:image' content={metatags.og_image} />} {/** SET DEFAULT */}
			<meta property='og:type' content='article' />
			{metatags?.twitter_site && <meta name='twitter:site' content={`@${metatags?.twitter_site}`} />} {/** SET DEFAULT */}
			{metatags?.twitter_title && <meta name='twitter:title' content={metatags?.twitter_title} />}
			{metatags?.twitter_description && <meta name='twitter:description' content={metatags.twitter_description} />}
			{metatags?.twitter_card && <meta name='twitter:card' content={metatags.twitter_card} />} {/** SET DEFAULT */}
			{metatags?.twitter_image && <meta name='twitter:image' content={metatags.twitter_image} />} {/** SET DEFAULT */}
		</Head>
	);
};
