	...
	const footerSections = [
		{
			...
			children: [
				...
				{ title: 'Featured Articles!', href: '' },
				{ title: 'Articles & Blogs', href: '' },
				{ title: 'Article Categories', href: '' },
				{ title: 'Article Tags', href: '' },
				{ title: 'About Us', href: '' },
				{ title: 'Our Excos', href: '' },
				{ title: 'Our Gallery', href: '' },
				{ title: 'Sermons', href: '' },
				{ title: 'Give Tithes & Offerings', href: '' },
		...
		},
		{
			...
			children: [
				{ title: 'Bible Study Group', href: '' },
				{ title: 'Evangelism Group', href: '' },
			],
		},
	];
